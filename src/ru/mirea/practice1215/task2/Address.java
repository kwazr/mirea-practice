...
public class Address {
    ...
    public static void main(String[] args) {
        ...
        Address a2 = new Address("Россия, Московская область, Москва, Проспект Вернадского, 78, 4, 1", true);
        Address a3 = new Address("UK, London, London, Kingsway, 75, 2, 3", true);
        Address a4 = new Address("Россия, Московская область, Москва, Корнейчука, 52, 1, 135", false);
